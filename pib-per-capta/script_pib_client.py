...
def main():
    ...
    calculate.get_region_by_state('Minas Gerais')
    calculate.get_state_by_region_for('CO')
    calculate.get_state_by_region_data_frame('CO')
    calculate.state_count()
    calculate.region_count()
    calculate.first_region_state()
    calculate.last_region_state()
main()
