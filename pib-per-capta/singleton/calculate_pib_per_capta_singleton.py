...
cada regra em um código é uma função ou método
que contém as assinaturas.
Uma assinatura é a definição de um método, com parâmetros,
tipos e retorno.

No exemplo abaixo CalculatePibPerCapta:
...
R: 4
4- Como podemos violar o contrado da AbstractCalculatePib?
R: Não implementando a classe AbstractCalculatePib ou não implementando ao menos um método da classe CalculatePibPerCaptaSingleton
'''
